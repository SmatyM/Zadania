defmodule ClothingDashboard1Web.ProductLiveTest do
  use ClothingDashboard1Web.ConnCase

  import Phoenix.LiveViewTest
  import ClothingDashboard1.CatalogFixtures

  @create_attrs %{description: "some description", title: "some title", category: "some category", price: "120.5", stock: 42, photo: "some photo"}
  @update_attrs %{description: "some updated description", title: "some updated title", category: "some updated category", price: "456.7", stock: 43, photo: "some updated photo"}
  @invalid_attrs %{description: nil, title: nil, category: nil, price: nil, stock: nil, photo: nil}
